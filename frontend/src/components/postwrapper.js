...
function GoToPostRedirect(props) {
    ...
    return(
        <h1 style={{color: "white", textDecoration:"underline"}} onClick={() => handleClick()} class="title">
            {props.pps.title}
        </h1>
    )
    ...
    render () {
        return (
            <div style={{color: "white"}}>
                ...
                <div className="karma" style={{paddingTop:"0.4em", fontSize:"24px"}}>
                    ...
                    <div style={{paddingTop:"0.2em"}}>
                        <Post title={this.props.title} showtitle={false} image={this.props.image} desc={this.props.desc} />
                    </div>
